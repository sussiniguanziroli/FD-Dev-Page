    ...
    return (
        <>
            <main className='initialServices-mobile hiddenInDesktop'>
                <h1 data-aos="fade-up">DISEÑO WEB</h1>
                <p data-aos="fade-up">Creamos sitios web atractivos y funcionales, adaptados a las necesidades específicas de tu negocio. Desde páginas informativas hasta plataformas de comercio electrónico, garantizamos una experiencia de usuario excepcional.</p>
                <img data-aos="fade-up" src="https://i.ibb.co/93fMk5N/servicios-1.png" alt="serv-1" />

                <h1 data-aos="fade-in">ASESORAMIENTO PERSONALIZADO</h1>
                <p data-aos="fade-in">Ofrecemos asesoramiento personalizado y presencial para ayudarte a tomar las mejores decisiones en tu estrategia digital y guiarte en cada paso del proceso.</p>
                <img data-aos="fade-in" src="https://i.ibb.co/gFRwnmp/servicios-2.png" alt="serv-2" />

                <h1 data-aos="fade-in">DISEÑAMOS EL LOGO PARA TU EMPRESA</h1>
                <p data-aos="fade-in">Diseñamos logos únicos y memorables que reflejan la identidad y valores de tu empresa. Un buen logo es clave para establecer una marca fuerte y reconocible.</p>
                <img data-aos="fade-in" src="https://i.ibb.co/YZZ2xtn/servicios-3.png" alt="serv-3" />
            </main>
