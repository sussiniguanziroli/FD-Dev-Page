...
const Servicios = () => {
    ...
    return (
        <>
            {/* SERVICIOS MOBILE */}
            <main className='animate__animated animate__fadeIn main-services-mobile hiddenInDesktop'>
                ...
                <div className='contacto-ahora-mobile'>
            ...
            {/* SERVICIOS DESKTOP */}
            <main className='animate__animated animate__fadeIn main-services-desktop hiddenInMobile'>
                <h1>Nuestros Servicios</h1>
                <p>En Facil Digital, ofrecemos una amplia gama de servicios para cubrir todas tus necesidades digitales.</p>
                <strong>Explorá nuestros servicios y descubre cómo podemos ayudarte.</strong>
                ...
                <h2>¿Listo para empezar?</h2>
                <h1 className='h1-1'>CONTÁCTANOS AHORA</h1>

                <div className='contacto-ahora-desktop'>
                    <section className='section-contacts'>
